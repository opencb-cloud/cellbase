...
public class CellBaseMain {
	...
	private void initOptions() {
		...
		options = new Options();
		options.addOption(OptionFactory
				.createOption("build", "Build values: core, genome_sequence, variation, protein"));
		...
		options.addOption(OptionFactory.createOption("log-level",
				"DEBUG -1, INFO -2, WARNING - 3, ERROR - 4, FATAL - 5", false));
	}
